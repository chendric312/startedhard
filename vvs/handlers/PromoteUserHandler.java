...
public class PromoteUserHandler extends PageTemplateHandler {
			...
			if(!isCurrentUserBanned) {
				...
				if(isCurrentUserAdministrator) {
					...
					String sql = "UPDATE " + Database.DB_NAME + "." + Database.USERS_TABLE + " SET " 
				    		  + Database.USERS_TABLE_ROLE + "='" + UserSession.Role.ADMIN.toString() + "';";
					...
					try {
						...
						return getRedirect("/users/" + user + "?message=User '" + URLEncoder.encode(user, "UTF-8") + "' has been promoted.");
