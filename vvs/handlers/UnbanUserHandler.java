...
public class UnbanUserHandler extends PageTemplateHandler {
			...
			if(!isCurrentUserBanned) {
				...
				if(isCurrentUserAdministrator) {
					...
					try {
						...
						return getRedirect("/users/" + user + "?message=User '" + URLEncoder.encode(user, "UTF-8") + "' has been unbanned.");
